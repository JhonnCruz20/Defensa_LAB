...
#define UE_PROJECT_NAME Galaga_USFX_Defensa
#define UE_TARGET_NAME Galaga_USFX_DefensaEditor
#define UE_MODULE_NAME "Galaga_USFX_Defensa"
...
#define GALAGA_USFX_DEFENSA_API DLLEXPORT
